...
class K_Medians(Cluster):
    ...
    def k_medians(self, k: int):
        ...
        while convergence_steps < 2:    # Repeat step 2 and 3 until convergence (no object has moved between clusters or by specified iteration)
            convergence_steps += 1
            ...
            cluster_representative = self.compute_new_cluster_representatives(cluster_representative, feature_belongs_to_cluster)
